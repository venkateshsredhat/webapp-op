...
import (
	...
	"github.com/venkateshsredhat/webapp-operator/controllers"
...
func init() {
	...
	utilruntime.Must(webappgroupv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b17519f3.venkateshsredhat.com",
